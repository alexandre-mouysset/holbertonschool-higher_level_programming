...
class Square(Rectangle):
    ...
    that is validated as a positive integer. It inherits the area
    method from Rectangle and provides a custom string representation.
    """
    ...
    def __str__(self):
        ...
        Returns:
            str: A formatted string showing [Square] <width>/<height>.
        """
